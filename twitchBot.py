...
class twitchBot:
    ...
    def __init__(self, id, secret, MAX_LEN=None, maxLenPost=None, tokenizer=None, tokenizerLang=None, sequencesChar=None, tokenizerCharLongest=None, maxLenChar=None, numChar=None, cv=None, model=None, mode=MODE_READ, min=30):
        self.id = id
        self.secret = secret
        asyncio.run(self.func(MAX_LEN, maxLenPost, tokenizer, tokenizerLang, sequencesChar, tokenizerCharLongest, maxLenChar, numChar, cv, model, mode, min))
